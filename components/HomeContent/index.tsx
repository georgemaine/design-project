  ...
  return (
    <>
      ...
      <main className="w-full h-full flex min-h-screen flex-col relative">
        <div className="relative flex flex-col items-center justify-center mt-52 z-10">
          <Logo />
          <h1 className="text-8xl font-bold leading-20 text-center tracking-tighter mt-5">
            Discovery
          </h1>
          ...
          <CursorTarget enabled={true} className={"mt-10"}>
